...
import { BookOpen, LayoutDashboard, HeartPulse, BrainCircuit, Zap, FileSearch, Library, GraduationCap, Video } from 'lucide-react';
import {
  Sidebar,
  SidebarHeader,
  SidebarMenu,
...
export function MainNav() {
  ...
  const menuItems = [
    ...
    { href: '/promo-video', label: 'Promo Video', icon: Video },
  ];
