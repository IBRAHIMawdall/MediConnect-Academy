...
const llmData: YearData[] = [
  {
    ...
    models: [
      ...
      { name: 'Dr. Knows', type: 'medical' },
      { name: 'BioCPT', type: 'medical' },
      { name: 'DeID-GPT', type: 'medical' },
      { name: 'ChatCAD', type: 'medical' },
      { name: 'MEDITRON', type: 'medical' },
      { name: 'BianQue', type: 'medical' },
      { name: 'AlpaCare', type: 'medical' },
      { name: 'CPLLM', type: 'medical' },
      { name: 'Qilin-Med', type: 'medical' },
      { name: 'Clinical Camel', type: 'medical' },
      { name: 'Zhongjing', type: 'medical' },
      { name: 'LLaMA2', type: 'base' },
      { name: 'ClinicalGPT', type: 'medical' },
      { name: 'MedPaLM2', type: 'medical' },
      { name: 'OphGLM', type: 'medical' },
      { name: 'GatortronGPT', type: 'medical' },
      { name: 'Baichuan', type: 'base' },
      { name: 'HuatuoGPT', type: 'medical' },
      { name: 'PMC-LLaMA', type: 'medical' },
      { name: 'MedAlpaca', type: 'medical' },
