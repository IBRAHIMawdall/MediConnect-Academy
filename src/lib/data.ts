    ...
    modules: [
      {
        ...
        lessons: [
          { title: 'The Pediatric Assessment Triangle', content: 'Learn to use the Pediatric Assessment Triangle (PAT) for rapid, systematic initial assessment of a child\'s appearance, work of breathing, and circulation. This framework helps to quickly identify the type and severity of physiologic abnormality. The PAT consists of three components: Appearance (muscle tone, interactiveness, consolability, look/gaze, speech/cry), Work of Breathing (abnormal sounds, abnormal positioning, retractions, flaring), and Circulation to skin (pallor, mottling, cyanosis). This systematic approach allows for rapid categorization of pediatric patients and guides initial treatment priorities.' },
          { title: 'Developmental Considerations', content: 'This lesson covers key age-specific differences in anatomy, physiology, and psychology that impact emergency care, from neonates to adolescents. Understand how to adapt your assessment and treatment for different developmental stages. MEDICATION SAFETY FOR BABIES: Weight-based dosing is critical (mg/kg calculations), consider immature liver and kidney function affecting drug metabolism, use age-appropriate formulations (liquid vs. solid), be aware of contraindicated medications in infants (aspirin, honey-based products), and always verify dosing with pediatric references. Common safe medications for babies include acetaminophen (10-15 mg/kg every 4-6 hours), ibuprofen (5-10 mg/kg every 6-8 hours, only >6 months), and saline drops for nasal congestion.' },
        ],
      },
      {
        title: 'Module 2: Common Pediatric Emergencies',
        lessons: [
          { title: 'Respiratory Distress', content: 'A deep dive into the most common pediatric respiratory emergencies, including diagnosis and management of croup, bronchiolitis, asthma exacerbations, and foreign body aspiration. MEDICATIONS FOR BABY BREATHING PROBLEMS: Albuterol nebulizer (2.5mg in 3ml saline for infants), Epinephrine racemic for severe croup (0.25-0.5ml of 2.25% solution), Dexamethasone for croup (0.15-0.6 mg/kg PO/IV), Prednisolone for asthma (1-2 mg/kg/day), and oxygen therapy as needed. Always monitor for side effects and ensure proper dosing based on weight. Bronchiolitis in infants typically requires supportive care with suctioning and hydration rather than bronchodilators.' },
          { title: 'Febrile Seizures', content: 'Understand the difference between simple and complex febrile seizures, the diagnostic workup, and evidence-based management strategies. This lesson also covers parental education and reassurance. FEVER MANAGEMENT IN BABIES: Acetaminophen (10-15 mg/kg every 4-6 hours, safe from birth), Ibuprofen (5-10 mg/kg every 6-8 hours, only for babies >6 months old), tepid sponge baths, and adequate hydration. NEVER give aspirin to children due to Reye syndrome risk. For seizures lasting >5 minutes: Rectal diazepam (0.2-0.5 mg/kg) or Midazolam (0.2 mg/kg buccal/intranasal). Most febrile seizures are benign and self-limiting. Focus on treating the underlying fever and providing family education about seizure safety and when to seek emergency care.' },
        ],
      },
    ],
    category: 'Clinical Medicine',
